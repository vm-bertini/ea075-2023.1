...
### Configurabilidade
> A estufa está sendo projetada para uma diversidade de espécies de plantas, no qual cada planta tem sua especificidade em relação ao ambiente para ter uma produtividade melhor. Portanto, será possível configurar a faixa de valores desejada e a frequência com que os dados serão lidos pelos sensores para operar dentro da estufa nos leitores de temperatura, umidade e luminosidade. Essa configuração será feita por botões conectados no painel LCD que vai constatemente mostrar o estado atual no interior da estufa e toda configuração será feita nele, apertando o botão do menu e indo em configurações.Por conseguinte, Terá 4 botões, um botão para entrar na tela de  configuração do sistema e sair e outros, outro botão para ir até o parâmetro desejado que no caso seriam 6 parâmetros, o valor min e max da faixa de valores dos 3 sensores utilizados e mais dois botões para incrementar e decrementar em 1 o valor do parâmetro selecionado.
### Eventos
