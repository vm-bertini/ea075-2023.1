...
O sistema deverá verificar a umidade do solo a cada 12h, decidir molhar ou não. Além de verificar interrupções provenientes dos botões quanto à: a)molhar naquele momento; b) fertilizar naquele momento e; c) ativar modo iluminação artificial.
